...
(function (global) {
    ...
    function mount(el, opts) {
        ...
        if (want && want !== 'Re-main') return null;
        ...
        if (isLandRoot) {
            try {
                if (global.__LAND_WIDGET_LOCK && global.__LAND_WIDGET_LOCK !== 'Re-main') {
                    return null;
                }
            } catch (eLock) {}
        ...
        if (isLandRoot) {
            try {
                global.__LAND_WIDGET_LOCK = 'Re-main';
            } catch (eL2) {}
        }
    ...
    function auto() {
        ...
        var el = document.querySelector('[data-land-mount="Re-main"]');
